...
function createSharedLink($folderid, $access_token, $access){
  $a = ["access" => $access];
  $data = array("shared_link" => $a);
  $header = array();
  $header[] = 'Authorization: Bearer'.' '.$access_token;
  $options = array(
  CURLOPT_URL => 'https://api.box.com/2.0/folders/'.$folderid,
...
//createSharedLink($folderid, $access_token, "collaborators");
